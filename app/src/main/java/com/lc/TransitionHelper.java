...
public class TransitionHelper {
    ...
    public static void startIntroAnim(View root, AnimatorListenerAdapter introEndListener) {
        introAnimate((DepthLayout) root.findViewById(R.id.dl1), MOVE_Y_STEP * 2f, 20f, 105, 190);
        introAnimate((DepthLayout) root.findViewById(R.id.dl2), MOVE_Y_STEP * 6f, 20f, 505, 200);
        introAnimate((DepthLayout) root.findViewById(R.id.dl3), MOVE_Y_STEP * 5f, 20f, 405, 210);
        introAnimate((DepthLayout) root.findViewById(R.id.dl4), MOVE_Y_STEP * 4f, 20f, 305, 220);
        introAnimate((DepthLayout) root.findViewById(R.id.dl5), MOVE_Y_STEP * 3f, 20f, 205, 230).addListener(introEndListener);
    }

    /**
     * @param target
     * @param moveY
     * @param customElevation 高度
     * @param delay           延迟
     * @param subtractDelay
     * @return
     */
    ...
    public static void startExitAnim(View root) {
        exitAnimate((DepthLayout) root.findViewById(R.id.dl1), MOVE_Y_STEP * 2f, 20, 45, 210, true);
        exitAnimate((DepthLayout) root.findViewById(R.id.dl2), MOVE_Y_STEP, 20f, 60, 230, true);
        exitAnimate((DepthLayout) root.findViewById(R.id.dl3), MOVE_Y_STEP, 20f, 75, 250, true);
        exitAnimate((DepthLayout) root.findViewById(R.id.dl4), MOVE_Y_STEP, 20f, 90, 270, true);
...
//        hideStatusBar(root);
        ...
        exitAnimate((DepthLayout) root.findViewById(R.id.dl3), MOVE_Y_STEP * 5f, 20f, 205, 250, false);
...
//        translationY.start();
    ...
    public static void animateMenuOut(View root) {
        continueOutToRight((DepthLayout) root.findViewById(R.id.dl1), MOVE_Y_STEP * 2f, 40);
        ...
        continueOutToRight((DepthLayout) root.findViewById(R.id.dl4), MOVE_Y_STEP * 3, 100);
        continueOutToRight((DepthLayout) root.findViewById(R.id.dl5), MOVE_Y_STEP * 4, 120);
    }

    public static void startRevertFromMenu(View root, AnimatorListenerAdapter animatorListenerAdapter) {
        revertFromMenu((DepthLayout) root.findViewById(R.id.dl1), 20f, 105, 6);
        revertFromMenu((DepthLayout) root.findViewById(R.id.dl2), 20f, 505, 1);
        revertFromMenu((DepthLayout) root.findViewById(R.id.dl3), 20f, 405, 2);
        revertFromMenu((DepthLayout) root.findViewById(R.id.dl4), 20f, 305, 3);
        revertFromMenu((DepthLayout) root.findViewById(R.id.dl5), 20f, 205, 4).addListener(animatorListenerAdapter);
